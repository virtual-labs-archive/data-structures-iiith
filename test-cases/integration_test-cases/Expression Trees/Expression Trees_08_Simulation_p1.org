...
* Test Steps
  ...
  6. Click on the Inorder and and repeat 5th step
...
* Expected result
  ...
  6. When we click on the Inorder link , the Inorder simulation preocess should start and it should be displayed on the screen
