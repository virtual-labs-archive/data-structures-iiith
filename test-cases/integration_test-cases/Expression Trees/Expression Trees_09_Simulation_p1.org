...
* Test Steps
  ...
  6. Click on the Post-order and and repeat 5th step
...
* Expected result
  ...
  6. When we click on the Post-order link , the pre-order simulation preocess should start and it should be displayed on the screen
