...
* Test Steps
  ...
  4. Don't enter a value and click on insert button

* Expected result
  1. Simulation page should be opened
  2. Content should be present with no distortions and Junk characters
  3. A new tab should be opened with the simulation process
  4. An error message should be displayed on the screen to enter the values and then click on the insert button
