...
* Pre conditions
  ...
  3. Select Data Structures, a home page will be displayed and click on  experiments link,  where a list of experiments will be displayed 
  4. Select  "Expression Evaluation using Stacks" experiment.
