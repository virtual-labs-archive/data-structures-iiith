...
* Test Steps
  ...
  4. Enter the valid values in Fisrt and don't enter the values in Second Binary values in the corresponding fields and click on the 'Mul' button and vice-vesa
...
* Expected result
  ...
  4. When we click on the Mul button 'an error message should be displayed on the screen as to enter the Binary values,
