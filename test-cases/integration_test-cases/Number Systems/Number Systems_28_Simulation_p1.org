...
* Test Steps
  ...
  4. Enter the  invalid values in Fisrt and Second Binary values in the corresponding fields and click on the 'Mul' button

* Expected result
  1. Simulation page should be opened
  2. Content should be present with no distortions and Junk characters
  3. When we click on the Binary system, it should redirect to a new tab
  4. An error message should be displayed on the screen as to enter the first and second Binary values.
